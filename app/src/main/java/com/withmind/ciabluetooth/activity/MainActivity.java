...
import com.withmind.ciabluetooth.databinding.ActivityMainBinding;
...
import com.withmind.ciabluetooth.util.CustomDialog;
...
//        super.onCreate(savedInstanceState);
    ...
    private void saveData() {
        ...
        if (battery >= 20) {
            ...
            mBinding.percentTextContainer.setVisibility(View.GONE);
